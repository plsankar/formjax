            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
                ...
                <div className="py-12 md:py-20">
                    ...
                    <div className="pb-12 text-center md:pb-20">
                        <h1
                            className="font-sora animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.emerald.200),theme(colors.gray.50),theme(colors.emerald.300),theme(colors.gray.200))] bg-[length:200%_auto] bg-clip-text pb-5 font-nacelle text-4xl font-semibold text-transparent md:text-5xl"
                            data-aos="fade-up"
                        >
                            AI-driven tools for product teams
                        </h1>
                        <div className="mx-auto max-w-3xl">
                            <p className="mb-8 text-xl text-emerald-200/65" data-aos="fade-up" data-aos-delay={200}>
